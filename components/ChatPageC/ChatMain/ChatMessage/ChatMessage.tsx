    ...
    <div
      ...
      <div
        ...
        className={cn(s.chatMessage_main, {
          [s.chatMessage_main_currentUser]: isCurrentUserMessage,
        })}
        // style={
      ...
      >
        <div className={s.chatMessage_content}>
          {!isCurrentUserMessage && isGroupChat && (
            <div className={s.chatMessage_username}>{author.username}</div>
          )}
          <div className={s.chatMessage_message}>
            ...
            <span
              className={s.chatMessage_time}
              style={isCurrentUserMessage ? { color: '#fff' } : {}}>
              {formattedTime}
            </span>
          </div>
        </div>
